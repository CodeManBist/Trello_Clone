...
-- AddForeignKey
ALTER TABLE "IssuesMapping" ADD CONSTRAINT "IssuesMapping_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "IssuesMapping" ADD CONSTRAINT "IssuesMapping_issueId_fkey" FOREIGN KEY ("issueId") REFERENCES "Issue"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
